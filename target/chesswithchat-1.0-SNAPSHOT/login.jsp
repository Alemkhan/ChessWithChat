...
<html>
    <head>
        ...
        <style>
            ...
            #cover {
                background: linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.5)), url('https://wallpapercave.com/wp/wp3025495.png');
        ...
        <section id="cover">
            <div class="container mt-5 col-6">
               <div class="row text-white">
                   ...
                   <%=(request.getAttribute("string") == null) ? "" : request.getAttribute("string")%>
               </div>
            </div>
        </section>
